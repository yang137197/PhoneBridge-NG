...
| P2-004 本地移除、截屏与配对体验收口 | 已实现并通过自动验证及 Samsung 定向实测；r14 等待真实跨端配对、记录管理和移除重配验收 | [验收记录](docs/audit/P2-004-VALIDATION.md)、[当前任务](docs/tasks/active/P2-004-local-removal-and-screenshot-policy.md) |
