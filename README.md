...
| P2-004 本地移除、截屏与配对体验收口 | r15 已修复手机批准后过早关闭结果的竞态并通过自动验证及 Samsung 定向测试；等待真实复验 | [验收记录](docs/audit/P2-004-VALIDATION.md)、[当前任务](docs/tasks/active/P2-004-local-removal-and-screenshot-policy.md) |
