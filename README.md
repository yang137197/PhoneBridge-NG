...
| P2-004 本地移除、截屏与全新验收流程 | 已实现并通过隔离验证；未配对候选不再显示为已连接且只进入添加手机流程，r13 等待用户端到端验收 | [验收记录](docs/audit/P2-004-VALIDATION.md)、[当前任务](docs/tasks/active/P2-004-local-removal-and-screenshot-policy.md) |
