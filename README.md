...
| P2-004 本地移除、截屏与全新验收流程 | 已实现并通过隔离验证；修正先配对、后共享、手动连接及配对候选迟到后未选中的缺陷，r12 等待用户端到端验收 | [验收记录](docs/audit/P2-004-VALIDATION.md)、[当前任务](docs/tasks/active/P2-004-local-removal-and-screenshot-policy.md) |
